...
import cover from "../../assets/picture/airbnb-cover.jpg";
    ...
    <div className="twitter miniproject">
      ...
      <figcaption>
        <div className="card-head d-flex justify-content-between align-items-center ">
          <h3><strong>landingpage</strong></h3>
          <p><small>self</small></p>
        </div>
        <div className="card-sub-head">
          <h4>Practice Airbnb clone</h4>
        </div>
        <div className="card-body">
          <p>Landing page practice HTML and CSS(vanila) by recreate Airbnb homepage </p>
        </div>
